...
public:
	...
	Matrix();
	explicit Matrix(int N); // Explicit er ikke del av pensum, men vi trenger det for å få oppførselen vi ønsker
...
// Valgfri oppgave
Matrix operator*(double lhs, const Matrix & rhs); // Multipliser med en double på venstre side
